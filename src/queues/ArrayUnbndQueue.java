...
public class ArrayUnbndQueue<T> implements UnboundedQueueInterface<T> 
{
	...
	private void enlarge()	// Increments the capacity of the queue by an amount equal to the original capacity.
	{
		T[] larger = (T[]) new Object[queue.length + origCap];	// create the larger array
